...
class LIS3MDL(I2C):
    ...
    # I2C addresses
    I2C_LIS3MDL_WHO_ID              = 0x3D
    I2C_LIS3MDL_SA0_HIGH_ADDRESS    = 0x1e  # Default / Master
    I2C_LIS3MDL_SA0_LOW_ADDRESS     = 0x1c  # Grounded / Slave
    ...
    def __init__(self, busId = 1, sa0 = SA0_HIGH):
        ...
        """
        super(LIS3MDL, self).__init__(busId)   # Enable I2C base class

        self.I2C_ADDR = self.I2C_LIS3MDL_SA0_HIGH_ADDRESS # Default (Master)
        if sa0 == SA0_LOW:
            self.I2C_ADDR = self.I2C_LIS3MDL_SA0_LOW_ADDRESS # (Slave mode)
    ...
    def __del__(self):
        ...
        try:
            ...
            self._writeRegister(self.I2C_ADDR, self.LIS_CTRL_REG3, 0x03)
    ...
    def enable(self, magnetometer = True, temperature = True):
        ...
        self._writeRegister(self.I2C_ADDR, self.LIS_CTRL_REG1, 0x00)
        self._writeRegister(self.I2C_ADDR, self.LIS_CTRL_REG3, 0x03)
        ...
        self._writeRegister(self.I2C_ADDR, self.LIS_CTRL_REG3, 0x00)
        ...
        if magnetometer:
            ...
            # CTRL_REG2
            # +/- 4 gauss full scale
            self._writeRegister(self.I2C_ADDR, self.LIS_CTRL_REG2, 0x00);

            # CTRL_REG4
            # Ultra-high-performance mode for Z
            # 00001100b
            self._writeRegister(self.I2C_ADDR, self.LIS_CTRL_REG4, 0x0c);
        ...
        self._writeRegister(self.I2C_ADDR, self.LIS_CTRL_REG1, ctrl_reg1)
    ...
    def getMagnetometerRaw(self):
        ...
        return self._getSensorRawLoHi3(self.I2C_ADDR, self.magRegisters)
    ...
    def getTemperatureRaw(self):
        ...
        # Return raw sensor data
        return self._getSensorRawLoHi1(self.I2C_ADDR, self.lisTempRegisters)
